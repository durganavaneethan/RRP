...
variable "Storage_account_SingleInstance"{
             default = "singleinstancestorageacc"
}
...
################### VARIABLES_FOR_MULTIPLE_INSTANCE #################################

variable "ResourceGroup_name_MultiRRP"{
             default = "MultiRRP"
}
variable "virtual_network_name_MultiRRP"{
             default = "MultiRRPVirtualNetwork"
}
variable "subnet_name_MultiRRP"{
             default = "MultiRRPSubnet"
}
variable "publicip_MultiRRP"{
             default = "MultiRRPPublicip"
}
variable "network_interface_MultiRRP"{
             default = "MultiRRPNI"
}
variable "ipconfiguration_MultiRRP"{
             default = "MultiRRPipconfiguration"
}
variable "Storage_account_MultiRRP"{
             default = "multirrpstorageacc"
}
variable "VM_name_MultiRRP"{
             default = "MultiRRPVM"
}
variable "Storage_OS_disk_name_MultiRRP"{
             default = "MultiRRPOSdisk"
}
...
################### VARIABLES_FOR_ACCEPTENCETESTING_INSTANCE #################################

variable "ResourceGroup_name_attdVM"{
             default = "attdVM"
}
variable "virtual_network_name_attdVM"{
             default = "attdVMVirtualNetwork"
}
variable "subnet_name_attdVM"{
             default = "attdVMSubnet"
}
variable "publicip_attdVM"{
             default = "attdVMPublicip"
}
variable "network_interface_attdVM"{
             default = "attdVMNI"
}
variable "ipconfiguration_attdVM"{
             default = "attdVMipconfiguration"
}
variable "Storage_account_attdVM"{
             default = "attdvmstorageacc"
}
variable "VM_name_attdVM"{
             default = "attdVM"
}
variable "Storage_OS_disk_name_attdVM"{
             default = "attdVMOSdisk"
}
